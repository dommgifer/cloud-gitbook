...
![Grafana Dashboard](../.gitbook/assets/grafana-gnocchi/dashboard-login.jpg)
...
![Gnocchi Datasource](../.gitbook/assets/grafana-gnocchi/gnocchi-datasource.jpg)
...
![Import dashboard](../.gitbook/assets/grafana-gnocchi/import-dashboard.jpg)

## 修改 Dashboard

匯入後會看到已存在 VM 的監測值，在 Memory 那欄會出現驚嘆號，這是因為原作者要顯示 Memory 使用率，但是 Memory 的 query 有誤，所以需要修改。

![](../.gitbook/assets/grafana-gnocchi/dashboard-overview.jpg)

點選 Memory usage 旁的箭頭，選 edit，並依照下圖修改

![](../.gitbook/assets/grafana-gnocchi/memory-query-edit.jpg)

這裡 Memory 的單位是錯誤的，所以也要修改，改為 MegaByte

![](../.gitbook/assets/grafana-gnocchi/unit-config.jpg)
...
![](../.gitbook/assets/grafana-gnocchi/variable-config.jpg)

這樣就可以點選左上角的 INSTANCE 來選擇要顯示的 VM監控值了，記得要存檔喔

![](../.gitbook/assets/grafana-gnocchi/vm-selector.jpg)
